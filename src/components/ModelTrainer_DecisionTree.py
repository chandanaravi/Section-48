...
class ModelTrainer_DecisionTree:
    def __init__(self):
        ...
        filename_str ="DecisionTree_Model_Obj_" + current_datetime.strftime("%Y-%m-%d_%H-%M-%S")
    ...
    def TrainModel_and_Save(self,X_train,y_train):
        model,para=self.model_config.get_model_with_params("Decision Tree")
